var generalSearch = {
	init: function(){
		...
		var locationDomain = "http://house.ifeng.com";
		var headurl_0,headurl;
		if( !/house.ifeng.com/.test(locationUrl) ){
	...
	searchSubmit: function(){
		...
		if( sort == "house" ){
			if( kw_lp != "" ){
				window.open('http://'+site_domain+'house.ifeng.com/sale/search/' + _city + '/_/_/0_0_0_0_0_0_0_0_0_0_0_0_0_0.shtml?keyword='+encodeURIComponent(kw_lp));
			}else{
				window.open('http://'+site_domain+'house.ifeng.com/sale/search/' + _city + '/_/_/0_0_0_0_0_0_0_0_0_0_0_0_0_0.shtml');
			}
		}else if( sort == "news" ){
